/// This is a fork of @openzeppelin/hardhat-upgrades/src/deploy-proxy.ts with the `deploy` function modified so we can deploy using Create3
...
import {
  ...
  getInitializerData,
  getSigner,
} from '@openzeppelin/hardhat-upgrades/src/utils/index';

import { getContractInstance } from '@openzeppelin/hardhat-upgrades/src/utils/contract-instance';
import { getInitialOwner } from '@openzeppelin/hardhat-upgrades/src/utils/initial-owner';
...
export function makeDeployProxy2(hre: HardhatRuntimeEnvironment): DeployFunction {
